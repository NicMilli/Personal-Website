...
function About() {
  return (
    <div className='aboutPage'>
      ...
      <br />
<p className='aboutBody pink'>He loves to solve problems! It was in South Africa that he learn't t find solutions with limited resources.</p>
    <br />
    <span>
    <img src={SABass} alt="Magazine Cover" className='SABass'/>
      <p>Nic on the cover of SA Bass magazine</p>
    </span>
    <br />
