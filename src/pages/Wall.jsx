    ...
    <div className='grad'>
      <div className="black">
        <div className="wallDescription">
          <p className="descriptionText">Please feel free to leave any messages or comments here.
      ...
      <p className="wallText-1">I would like to get visitors to sign with Firebase to avoid spam massages</p></div>
      <div className="center">
      <p className="wallText-2">Please be patient while I set this up as I am finishing some other projects first!</p>
      <p className='wallText-3'>Thank you for visiting!</p></div>
        </div>
      </div>
    </div>
    </div>
